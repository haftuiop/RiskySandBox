...
public partial class MultiplayerBridge_Photon_VariableSyncing
{
    ...
    void ObservableStringListEventReceiver_Onsynchronize(ObservableStringList _ObservableList)
	{
		...
		syncObservableStringList(_ObservableList, null);
	}


	void syncObservableStringList(ObservableStringList _ObservableList, Photon.Realtime.Player _target_Player)
    {
		//ok! we shall send the value
		string _rpc_name = "Pun_RPCreceiveNewValue_ObservableStringList";
		int _variable_index = this.my_ObservableVariables.my_ObservableStringLists.IndexOf(_ObservableList);
	...
	[Photon.Pun.PunRPC]
	void Pun_RPCreceiveNewValue_ObservableStringList(int _index, string[] _values,PhotonMessageInfo _PhotonMessageInfo)
    {
		ObservableStringList _ObservableList = this.my_ObservableVariables.my_ObservableStringLists[_index];
